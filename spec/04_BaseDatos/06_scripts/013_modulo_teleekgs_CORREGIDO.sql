-- ============================================================
-- SCRIPT 013 CORREGIDO: MÓDULO TELEEKGS
-- ============================================================
-- Creado: 2026-01-13
-- Correcciones: Usar nombres de tablas correctos del schema maestro_cenate
...
CREATE TABLE IF NOT EXISTS tele_ecg_imagenes (
    ...
    id_usuario_paciente BIGINT REFERENCES dim_usuarios(id) ON DELETE SET NULL,
    ...
    id_ipress_origen BIGINT NOT NULL REFERENCES dim_ipress(id),
    codigo_ipress VARCHAR(20),
    nombre_ipress VARCHAR(255),

    -- Receptor/Procesador
    id_usuario_receptor BIGINT REFERENCES dim_usuarios(id) ON DELETE SET NULL,
    ...
    created_by BIGINT REFERENCES dim_usuarios(id),
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_by BIGINT REFERENCES dim_usuarios(id),
...
CREATE TABLE IF NOT EXISTS tele_ecg_auditoria (
    ...
    -- Usuario
    id_usuario BIGINT NOT NULL REFERENCES dim_usuarios(id),
...
CREATE TABLE IF NOT EXISTS tele_ecg_estadisticas (
    ...
    -- Por IPRESS
    id_ipress BIGINT REFERENCES dim_ipress(id),
    codigo_ipress VARCHAR(20),
    nombre_ipress VARCHAR(255),
