...
ALTER TABLE ticket_mesa_ayuda ADD COLUMN IF NOT EXISTS fecha_atencion TIMESTAMP;

COMMENT ON COLUMN ticket_mesa_ayuda.fecha_atencion IS 'Fecha y hora en que el ticket fue marcado como RESUELTO';

-- Backfill: para tickets ya resueltos, usar fecha_respuesta como fecha_atencion
UPDATE ticket_mesa_ayuda
