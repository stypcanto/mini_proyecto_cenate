...
import styp.com.cenate.dto.mbac.AuditoriaModularResponseDTO;
import styp.com.cenate.model.view.AuditoriaModularView;
import styp.com.cenate.repository.mbac.AuditoriaModularViewRepository;
import styp.com.cenate.service.mbac.AuditoriaService;
...
/**
 * Implementación del servicio de auditoría modular.
 * Proporciona funcionalidades para consultar y analizar los registros
 * de auditoría de cambios en permisos modulares.
 * 
...
public class AuditoriaServiceImpl implements AuditoriaService {
    ...
    public Page<AuditoriaModularResponseDTO> obtenerAuditoriaModular(Pageable pageable) {
        log.info("Obteniendo auditoría modular - Página: {}, Tamaño: {}", 
    ...
    @Override
    public Page<AuditoriaModularResponseDTO> obtenerAuditoriaPorRangoFechas(
        ...
        Page<AuditoriaModularView> auditoria = auditoriaRepository.findByFechaHoraBetween(
    ...
    @Override
    public Page<AuditoriaModularResponseDTO> obtenerAuditoriaPorUsuarioYFechas(
            Long userId, 
            LocalDateTime fechaInicio, 
            LocalDateTime fechaFin, 
            Pageable pageable) {
        ...
        Page<AuditoriaModularView> auditoria = auditoriaRepository.findByUserIdAndFechaHoraBetween(
    ...
    @Override
    public Page<AuditoriaModularResponseDTO> obtenerAuditoriaPorModuloYAccion(
            String modulo, 
            String accion, 
            Pageable pageable) {
        ...
        Page<AuditoriaModularView> auditoria = auditoriaRepository.findByModuloAndAccion(
            modulo, accion, pageable
        );
        return auditoria.map(this::mapToAuditoriaResponseDTO);
    }
    ...
    public Map<String, Long> obtenerResumenPorTipoEvento() {
        ...
        log.debug("Resumen de eventos: {}", resumen);
        return resumen;
    }
    ...
    /**
     * Convierte una entidad AuditoriaModularView a AuditoriaModularResponseDTO.
     */
