...
public class ImportExcelController {
	 ...
	 *   - idBolsa: Long (ej: 4 para BOLSAS_EXPLOTADATOS)
	...
	public ResponseEntity<?> importarPacientes(
		...
		log.info("   Bolsa: {}, Servicio: {}, Usuario: {}", idBolsa, idServicio, usuarioCarga);

		try {
			Map<String, Object> result = service.importarYProcesar(file, usuarioCarga, idBolsa, idServicio);
