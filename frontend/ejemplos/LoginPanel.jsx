      ...
      <div className="login-box">
        ...
        <form onSubmit={handleLogin} className="login-form">
          ...
          <div className="form-group">
            ...
            <div className="input-with-icon">
              <span className="input-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="8" r="3" stroke="#999" strokeWidth="2"/>
                  <path d="M6 21C6 17.686 8.686 15 12 15C15.314 15 18 17.686 18 21" stroke="#999" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              </span>
              <input
                type="text"
                ...
                placeholder="Ej: superadmin, ADMIN001"
                required
                disabled={loading}
            ...
            <small className="input-hint">Ingresa tu código de usuario</small>
          </div>
        ...
        <div className="login-info">
          <small>
            <strong>Usuario de prueba:</strong> superadmin<br/>
            <strong>Contraseña:</strong> SuperAdmin2024!
          </small>
        </div>
      </div>
    </div>
