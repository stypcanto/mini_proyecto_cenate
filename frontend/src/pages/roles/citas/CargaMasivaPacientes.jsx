                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-amber-100">
                      <th className="px-3 py-2 text-left font-semibold text-amber-700 uppercase tracking-wide w-6">#</th>
                      <th className="px-3 py-2 text-left font-semibold text-amber-700 uppercase tracking-wide">DNI</th>
