...
export default function BienvenidaTeleurgencias() {
  ...
  const acciones = [
    ...
    {
      id: 2,
      titulo: 'Estadísticas Médicos',
      descripcion: 'Rendimiento y análisis por médico',
      icono: TrendingUp,
      gradient: 'from-blue-600 to-blue-800',
      ruta: '/roles/coordinador/teleurgencias/estadisticas',
    },
    {
      id: 3,
      titulo: 'Reasignación Pacientes',
      descripcion: 'Gestiona asignaciones de pacientes',
      icono: Users,
      gradient: 'from-amber-600 to-amber-800',
      ruta: '/roles/coordinador/teleurgencias/reasignar',
    },
    {
      id: 4,
      titulo: 'Exportación Excel',
      descripcion: 'Descarga reportes y análisis',
      icono: Download,
      gradient: 'from-emerald-600 to-emerald-800',
      ruta: '/roles/coordinador/teleurgencias/exportar',
    },
  ];
