  ...
  return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
        ...
        <section className="container mx-auto px-6 py-16">
          <div className="max-w-7xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-[0_0_30px_rgba(46,99,166,0.2)] transition-shadow">
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-3 p-10 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white">
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  El <span className="font-bold text-[#2e63a6]">CENATE</span> es
                  el órgano nacional de EsSalud que brinda atención médica a
                  distancia en los componentes de promoción, prevención,
                  recuperación y rehabilitación, usando tecnologías de información
                  y comunicación.
                </p>
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-5xl mx-auto mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                ...
                excelencia y seguridad en todos nuestros servicios de telemedicina.
              </p>
            </div>
        ...
        {/* CTA */}
        <section
            className="relative bg-gradient-to-r from-[#2e63a6] via-[#2456a0] to-[#1d4f8a] py-16 text-white overflow-hidden"
        >
          <div
              className="absolute inset-0 opacity-10"
              style={{ backgroundImage: patternSVG }}
