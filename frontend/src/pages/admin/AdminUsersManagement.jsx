                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {filtrados.map((usuario) => (
                            <tr key={usuario.idUser} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="text-sm font-medium text-gray-900">{usuario.nameUser}</div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <table className="w-full">
                    <thead className="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            ...
                            <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Régimen</th>
                            <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Estado</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {filtrados.map((p) => (
                            <tr key={p.idPers} className="hover:bg-gray-50">
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span className="text-sm font-medium text-gray-900">#{p.idPers}</span>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="text-sm font-medium text-gray-900">{p.perPers}</div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="text-sm text-gray-900">{p.regimenLaboral?.descRegLab || "N/A"}</div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
    ...
    const renderTiposDocumentoTable = () => {
        ...
        return renderSimpleTable(
            ...
            (item) => (
                <>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-gray-900">#{item.idTipDoc}</span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{item.descTipDoc}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        {getEstadoBadge(item.statTipDoc)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                            <button 
                            ...
                            <button 
                                onClick={() => handleDelete(item.idTipDoc)}
                                className="p-2 text-red-600 hover:bg-red-50 rounded-lg">
                                <Trash2 className="w-4 h-4" />
                            </button>
                        </div>
    ...
    const renderAreasTable = () => {
        ...
        return renderSimpleTable(
            ...
            (item) => (
                <>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-gray-900">#{item.idArea}</span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{item.descArea}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        {getEstadoBadge(item.statArea)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                            <button 
                            ...
                            <button 
                                onClick={() => handleDelete(item.idArea)}
                                className="p-2 text-red-600 hover:bg-red-50 rounded-lg">
                                <Trash2 className="w-4 h-4" />
                            </button>
                        </div>
    ...
    const renderRegimenesLaboralesTable = () => {
        ...
        return renderSimpleTable(
            ...
            (item) => (
                <>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-gray-900">#{item.idRegLab}</span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{item.descRegLab}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                        {getEstadoBadge(item.statRegLab)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                            <button 
                            ...
                            <button 
                                onClick={() => handleDelete(item.idRegLab)}
                                className="p-2 text-red-600 hover:bg-red-50 rounded-lg">
                                <Trash2 className="w-4 h-4" />
                            </button>
                        </div>
                    ...
                    <thead className="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            {headers.map((header, idx) => (
                                <th key={idx} className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">
                                    {header}
                                </th>
                            ))}
                        </tr>
                ...
                <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                    <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                        <h2 className="text-2xl font-bold text-gray-900">
                            ...
                            {activeTab === "personal" ? "Personal" : 
                             activeTab === "tiposDocumento" ? "Tipo de Documento" :
                             activeTab === "areas" ? "Área" : "Régimen Laboral"}
                        </h2>
                        <button 
                    ...
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="flex justify-end space-x-3 mt-6 pt-6 border-t">
                            ...
                            <button
                                type="submit"
                                className="flex items-center space-x-2 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold">
    ...
    const renderPersonalForm = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select
                    value={formData.idTipDoc}
                    onChange={(e) => setFormData({...formData, idTipDoc: e.target.value})}
                    required
                    ...
                    {tiposDocumento.map(t => (
                        <option key={t.idTipDoc} value={t.idTipDoc}>{t.descTipDoc}</option>
                    ))}
                </select>
            </div>
            ...
            <div>
                ...
                <input
                    type="text"
                    value={formData.numDocPers}
                    onChange={(e) => setFormData({...formData, numDocPers: e.target.value})}
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div className="md:col-span-2">
                ...
                <input
                    type="text"
                    value={formData.perPers}
                    onChange={(e) => setFormData({...formData, perPers: e.target.value})}
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <input
                    type="date"
                    value={formData.fechNaciPers}
                    onChange={(e) => setFormData({...formData, fechNaciPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <select
                    value={formData.genPers}
                    onChange={(e) => setFormData({...formData, genPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="">Seleccione...</option>
            ...
            <div>
                ...
                <input
                    type="text"
                    value={formData.movilPers}
                    onChange={(e) => setFormData({...formData, movilPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <input
                    type="email"
                    value={formData.emailPers}
                    onChange={(e) => setFormData({...formData, emailPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <input
                    type="email"
                    value={formData.emailCorpPers}
                    onChange={(e) => setFormData({...formData, emailCorpPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Código Plan Remuneración
                </label>
                <input
                    type="text"
                    value={formData.codPlanRem}
                    onChange={(e) => setFormData({...formData, codPlanRem: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div className="md:col-span-2">
                ...
                <input
                    type="text"
                    value={formData.direcPers}
                    onChange={(e) => setFormData({...formData, direcPers: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <select
                    value={formData.idRegLab}
                    onChange={(e) => setFormData({...formData, idRegLab: e.target.value})}
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="">Seleccione...</option>
                    {regimenesLaborales.map(r => (
                        <option key={r.idRegLab} value={r.idRegLab}>{r.descRegLab}</option>
                    ))}
                </select>
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    <option value="">Seleccione...</option>
                    {areas.map(a => (
                        <option key={a.idArea} value={a.idArea}>{a.descArea}</option>
                    ))}
                </select>
            </div>
            ...
            <div>
                ...
                <select
                    value={formData.statPers}
                    onChange={(e) => setFormData({...formData, statPers: e.target.value})}
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    const renderSimpleForm = () => (
        <div className="space-y-4">
            <div>
                ...
                <input
                    type="text"
                    value={simpleFormData.descripcion}
                    onChange={(e) => setSimpleFormData({...simpleFormData, descripcion: e.target.value})}
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => setSimpleFormData({...simpleFormData, estado: e.target.value})}
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="A">Activo</option>
                    <option value="I">Inactivo</option>
