            ...
            { formData.idModAten === getIdModalidadMixta() && (
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Ej: Cardiología - Consultorio disponible solo en horario matutino, de 7AM-1PM. Sin disponibilidad en las tardes. | Psicología - Consultorio solo disponible los Jueves y Viernes 8AM-12PM y 3PM-6PM"
                />
                <p className="mt-1 text-xs text-gray-500">
