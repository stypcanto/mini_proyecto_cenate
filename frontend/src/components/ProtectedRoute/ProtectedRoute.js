...
// Protege las rutas según autenticación y permisos RBAC.
// ========================================================================
...
export const ProtectedRoute = ({
  ...
  const hasPermission = verificarPermiso(requiredPath, requiredAction);
...
/**
 * HOC para envolver componentes individuales
 */
