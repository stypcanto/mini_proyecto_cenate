/**
 * Servicio API para Motivos de Deserción
 * v1.0.0 - 2026-03-02
 *
 * Base URL: /api/admin/motivos-desercion
 */

import { apiClient } from '../lib/apiClient';

const BASE_URL = '/api/admin/motivos-desercion';

class MotivosDesercionService {
  /** Obtener activos (para el modal de profesional de salud — sin auth especial) */
...
export const motivosDesercionService = new MotivosDesercionService();
export default motivosDesercionService;
